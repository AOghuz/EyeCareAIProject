...
{
    /// <inheritdoc />
    public partial class new_migrationtest : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Abouts", x => x.InfoId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TurkishIdentityNumber = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubDescription1 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SubTitle2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SubDescription2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SubTitle3 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SubDescription3 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SubTitle4 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SubDescription4 = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
